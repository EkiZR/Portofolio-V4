    ...
    <Box sx={{ flexGrow: 1, bgcolor: "transparent", display: "flex", height: "auto"}}>
      ...
      <SwipeableViews index={value} onChangeIndex={handleChangeIndex}>
        <TabPanel value={value} index={0}>
            ...
            <img src="/SocialMediaImg/Instagram.jpg" alt="" className="object-contain h-auto w-[10rem] md:w-[14.3rem]  rounded-xl " />
			</a>
        </TabPanel>
        <TabPanel value={value} index={1}>
		<a href="https://www.tiktok.com/@eki_zulfar">
		<img src="/SocialMediaImg/tiktok.jpg" alt="" className="object-contain h-auto w-[10rem] md:w-[14.3rem] rounded-xl" />
		</a>
	
        </TabPanel>
        <TabPanel value={value} index={2}>
			<a href="https://youtube.com/@eki_zulfar">
		<img src="/SocialMediaImg/youtube.jpg" alt="" className="object-contain h-auto w-[10rem] md:w-[14.3rem] rounded-xl" />
			</a>
        </TabPanel>
        <TabPanel value={value} index={3}>
			<a href="https://www.linkedin.com/in/ekizr/">
		<img src="/SocialMediaImg/linkedin.jpg" alt="" className="object-contain h-auto w-[10rem] md:w-[14.3rem] rounded-xl" />
			</a>
        </TabPanel>
      </SwipeableViews>
    </Box>
